...
Original file is located at
    https://colab.research.google.com/drive/1-JkXOmz0FDBGIsd9fZJOAGZLbWYzPFrk
"""

#intial code taken from: https://github.com/vishaldhiman28/Spoken-To-Written-English/blob/master/spoken2written/sp2wr.py
import re
